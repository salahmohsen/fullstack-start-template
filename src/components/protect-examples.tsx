...
export function ProtectExamples() {
  ...
  const { user, isAuthenticated, hasRole, hasPermission, canManageUsers, canDeleteUsers } =
    authData;
    ...
    <div className="space-y-8 p-6">
      ...
      <div className="space-y-4 text-center">
        ...
        <p className="mx-auto max-w-3xl text-xl text-muted-foreground">
          Learn how to implement authorization in your React components using the Better Auth
          Protect component. All examples include working demos and copy-ready code snippets.
        </p>
      </div>
  ...
  <div>
    ...
    {canManageBilling && <BillingSettings />}
              ...
              <Alert>
                ...
                <AlertDescription>
                  <strong>Dynamic Types:</strong> All resource and action types are automatically
                  derived from your <code>permissions.ts</code> configuration. Add new permissions
                  there and they'll be available here with full TypeScript support!
                </AlertDescription>
              </Alert>
            </TabsContent>
          </Tabs>
              ...
              <div>
                ...
                <Protect
                  condition={({ user: conditionUser }) => {
                    ...
                    return Boolean(
                      conditionUser && conditionUser.role && conditionUser.role !== "user",
                    );
                  }}
                  fallback={
                    <div className="rounded bg-muted p-3 text-sm text-muted-foreground">
  ...
  <BusinessTool />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Pre-built permission helpers and the useAuth hook for complex scenarios
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs className="w-full" defaultValue="demo">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <Alert>
              ...
              <AlertDescription>
                <strong>Security:</strong> Always implement server-side authorization checks.
                Client-side protection is for UX only, not security.
              </AlertDescription>
            </Alert>
            ...
            <Alert>
              <Code2 className="h-4 w-4" />
              <AlertDescription>
                <strong>Performance:</strong> Use the useAuth hook for multiple checks in the same
                component to avoid redundant authorization calls.
              </AlertDescription>
            </Alert>
            ...
            <Alert>
              ...
              <AlertDescription>
                <strong>Maintainability:</strong> Keep authorization logic in your permissions.ts
                file. The Protect component will automatically inherit changes.
              </AlertDescription>
            </Alert>
            ...
            <Alert>
              ...
              <AlertDescription>
                <strong>UX:</strong> Always provide meaningful fallback content to guide users on
                what they need to access protected features.
              </AlertDescription>
            </Alert>
          </div>
        </CardContent>
